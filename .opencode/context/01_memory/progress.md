...
- **Porting Features**:
  ...
  - [x] Architecture: Rich Prompt Input Design <!-- id: 11 -->
  - [x] Implementation: RichEditor Component <!-- id: 12 -->
  - [x] Implementation: editorDom Utilities <!-- id: 13 -->
  - [x] Implementation: Autocomplete Popovers <!-- id: 14 -->
  - [x] Implementation: Shell Mode & History <!-- id: 15 -->
  - [x] Validation: Rich Prompt Input E2E Tests <!-- id: 16 -->
