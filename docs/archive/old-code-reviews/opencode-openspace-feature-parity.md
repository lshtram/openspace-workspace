...
| Session title edit | ✅ | ❌ | packages/app/src/pages/session/message-timeline.tsx | target: openspace-client/src/components/sidebar/SessionSidebar.tsx |
| Session archive | ✅ | ❌ | packages/app/src/pages/session/message-timeline.tsx | target: openspace-client/src/hooks/useSessions.ts |
| Session delete | ✅ | ❌ | packages/app/src/pages/session/message-timeline.tsx | target: openspace-client/src/hooks/useSessions.ts |
...
| Session prefetch (adjacent) | ✅ | ❌ | packages/app/src/pages/layout.tsx | target: openspace-client/src/hooks/useSessions.ts |
| Session history pagination | ✅ | ❌ | packages/app/src/pages/session/message-timeline.tsx | target: openspace-client/src/hooks/useMessages.ts |
| Session navigation keybinds | ✅ | ❌ | packages/app/src/pages/layout.tsx | target: openspace-client/src/components/AgentConsole.tsx |
| “Unseen” session navigation | ✅ | ❌ | packages/app/src/pages/layout.tsx | target: openspace-client/src/hooks/useSessions.ts |
...
| Multi-server list + health | ✅ | ❌ | packages/app/src/components/status-popover.tsx | target: openspace-client/src/components/DialogManageServers.tsx |
| Default server management | ✅ | ❌ | packages/app/src/components/status-popover.tsx | target: openspace-client/src/components/DialogManageServers.tsx |
...
## Optional Desktop Features (OpenCode Desktop)
